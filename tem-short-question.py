...
output_folder = 'D:\\vene\\exp\\output\\short'  # 替换为你的输出文件夹路径
os.makedirs(output_folder, exist_ok=True)

# 将用户问题分成多个较小的部分
user_questions = [
    "Describe the color, model, collision location, casualties, surrounding environment, emergency response, and vehicle damage of the accident vehicles in the image"
]
