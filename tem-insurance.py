...
output_folder = 'D:\\vene\\exp\\output\\insurance'  # 替换为你的输出文件夹路径
os.makedirs(output_folder, exist_ok=True)

# 将用户问题分成多个较小的部分
user_questions = [
    "How is the damage to the front, sides, rear, etc. of the vehicle? Are there obvious scratches, dents, parts falling off or structural damage? Has the vehicle overturned or turned sideways? Are there any casualties involved? Have road facilities such as guardrails and street lights been hit by the vehicle?"
]
