...
output_folder = 'D:\\vene\\exp\\output\\news'  
os.makedirs(output_folder, exist_ok=True)

# 将问题分成多个较小的部分
user_questions = [
    "Describe the time of the accident and the number and type of vehicles involved.Describe the type of road and weather conditions. Whether there were casualties, traffic congestion, or damage to public facilities? Whether there were emergency vehicles at the scene"
]
# 批量处理所有图像
